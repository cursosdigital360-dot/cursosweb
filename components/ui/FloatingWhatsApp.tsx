...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 md:hidden animate-fade-in-up" style={{ animationDelay: '1s' }}>
      <Link 
        href={contact.whatsappUrl} 
        target="_blank" 
        rel="noopener noreferrer"
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-xl hover:scale-110 active:scale-95 transition-transform"
